...
const validatePostId_middleware_1 = require("../middlewares/validatePostId.middleware");
const router = (0, express_1.Router)();
router.get("/", postController.getAllPostsByUserId);
router.get("/posts/paginated", postController.getPostsByUserId);
router.post("/posts", postController.createPost);
router.delete("/:id", validatePostId_middleware_1.validatePostId, postController.deletePost);
